...
/**
 * JVM-specific GGUF weight loader that properly loads tensor data into model parameters.
 * Uses reflection to access the underlying buffer array of tensor data.
 */
fun loadGgufWeights(module: Module<FP32, Float>, source: Source) {
...
/**
 * Load GGUF weights from a ByteArray.
 */
fun loadGgufWeights(module: Module<FP32, Float>, bytes: ByteArray) {
    val source: Source = Buffer().apply { write(bytes) }
    loadGgufWeights(module, source)
}
